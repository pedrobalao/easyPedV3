...
class _WhoData {
  ...
  static const List<double> heightBoys15th = [
    47.9, 52.7, 56.4, 59.3, 61.7, 63.7, 65.5, 67.1, 68.6, 70.0,
    71.3, 72.5, 73.7, 74.9, 76.0, 77.1, 78.1, 79.1, 80.1, 81.0,
    82.0, 82.9, 83.8, 84.6, 85.5, 86.5, 87.3, 88.1, 88.9, 89.7,
    90.5, 91.2, 91.9, 92.6, 93.3, 94.0, 94.7, 95.4, 96.0, 96.7,
    97.3, 97.9, 98.6, 99.2, 99.8, 100.3, 100.9, 101.5, 102.1, 102.6,
    103.2, 103.8, 104.4, 104.9, 105.5, 106.0, 106.6, 107.1, 107.7, 108.2, 108.7,
  ];
  ...
  static const List<double> heightBoys85th = [
    51.8, 56.7, 60.5, 63.5, 66.0, 68.1, 69.8, 71.3, 72.8, 74.1,
    75.4, 76.7, 77.9, 79.0, 80.2, 81.3, 82.3, 83.4, 84.4, 85.4,
    86.4, 87.3, 88.2, 89.1, 90.0, 91.1, 91.9, 92.7, 93.5, 94.3,
    95.0, 95.8, 96.5, 97.3, 98.0, 98.7, 99.4, 100.0, 100.7, 101.4,
    102.0, 102.7, 103.4, 104.0, 104.6, 105.3, 105.9, 106.5, 107.1, 107.7,
    108.4, 109.0, 109.6, 110.2, 110.8, 111.4, 112.0, 112.6, 113.2, 113.8, 114.3,
  ];
  ...
  static const List<double> heightGirls15th = [
    47.2, 51.6, 54.9, 57.6, 59.9, 61.8, 63.4, 64.9, 66.4, 67.7,
    69.0, 70.3, 71.5, 72.6, 73.8, 74.9, 75.9, 77.0, 78.0, 78.9,
    79.9, 80.8, 81.8, 82.7, 83.5, 84.5, 85.3, 86.1, 86.9, 87.6,
    88.3, 89.0, 89.7, 90.4, 91.1, 91.8, 92.4, 93.1, 93.7, 94.3,
    95.0, 95.6, 96.2, 96.8, 97.4, 98.1, 98.7, 99.2, 99.8, 100.4,
    101.0, 101.6, 102.2, 102.8, 103.3, 103.9, 104.5, 105.1, 105.6, 106.2, 106.7,
  ];
  ...
  static const List<double> heightGirls85th = [
    51.0, 55.7, 59.2, 62.0, 64.3, 66.3, 68.0, 69.5, 71.0, 72.4,
    73.8, 75.1, 76.4, 77.6, 78.8, 79.9, 81.0, 82.1, 83.2, 84.2,
    85.2, 86.2, 87.2, 88.1, 89.1, 90.1, 91.0, 91.8, 92.6, 93.4,
    94.2, 94.9, 95.7, 96.4, 97.1, 97.8, 98.5, 99.2, 99.9, 100.5,
    101.2, 101.8, 102.5, 103.1, 103.8, 104.4, 105.0, 105.7, 106.3, 106.9,
    107.5, 108.2, 108.8, 109.4, 110.0, 110.7, 111.3, 111.9, 112.5, 113.1, 113.7,
  ];
    ...
    if (chartType == GrowthChartType.weight) {
      ...
      if (isMale) {
        return {
          ...
          'p15': _WhoData.heightBoys15th,
          'p50': _WhoData.heightBoys50th,
          'p85': _WhoData.heightBoys85th,
          'p97': _WhoData.heightBoys97th,
        };
      } else {
        return {
          'p3': _WhoData.heightGirls3rd,
          'p15': _WhoData.heightGirls15th,
          'p50': _WhoData.heightGirls50th,
          'p85': _WhoData.heightGirls85th,
